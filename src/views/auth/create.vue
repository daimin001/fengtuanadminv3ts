<template>
  <el-card>
    <template #header>
      <span>权限创建</span>
      <el-button type="default" @click="$router.push('/auth')">返回</el-button>
    </template>
    <el-form ref="formRef" :model="formData" label-width="80px" size="large" :rules="formRules">
...
import type { PostAuthPayloadType } from '@/api/auth/types'
import type { FormInstance, FormRules } from 'element-plus'

// 表单数据
const formData = reactive<PostAuthPayloadType>({
  auth_name: '',
  type: 1,
  path: '',
  component: '',
